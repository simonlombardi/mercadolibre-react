...
const Cart = () => {
  ...
  [pucharseComplete, setPucharseComplete] = useState(false)
  ...
  const pucharseFinish = () => {
    setPucharseComplete(true)
    setTimeout(()=>{
      setPucharseComplete(false)
      localStorage.clear()
    }, 2000)
          ...
          <div className="bg-[#EDEDED] h-fit flex justify-around px-28 py-11">
            ...
            <div className="w-4/12 bg-white rounded">
              ...
              <div className="w-full flex justify-center">
                <button onClick={pucharseFinish} className="bg-blue-500 h-12 w-7/12 px-2 hover:bg-blue-700 text-white self-center rounded">
                  Finalizar compra
                </button>
              </div>
            </div>
